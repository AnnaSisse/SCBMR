  ...
  const loadExaminations = async () => {
    try {
      ...
      const transformedExaminations = data.map((exam: any) => ({
        ...exam,
        patient_name: `Patient ${exam.patient_id}`,
        doctor_name: `Doctor ${exam.doctor_id}`,
        date_formatted: new Date(exam.date).toLocaleDateString(),
      }))
                  ...
                  {filteredExaminations.length === 0 ? (
                    ...
                    filteredExaminations.map((exam) => (
                      <TableRow key={exam.examination_id}>
                        ...
                        <TableCell>{exam.type || "N/A"}</TableCell>
